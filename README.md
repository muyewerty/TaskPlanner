...
* **Поддерживается работа на Windows, macOS и Linux благодаря аппаратному ускорению через OpenGL и фреймворку Kivy. В будущем планируется порт на мобильные устройства.**
